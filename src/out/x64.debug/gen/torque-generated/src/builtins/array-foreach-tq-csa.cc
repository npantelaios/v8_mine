...
TF_BUILTIN(ArrayForEachLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:13:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:14:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:15:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:16:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayForEachLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:31:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:32:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:33:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:34:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayForEach, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-foreach.tq", 111);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-foreach.tq", 114);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/array-foreach.tq", 123);
