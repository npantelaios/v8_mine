...
TF_BUILTIN(ArrayFilterLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:18:59");
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:20:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:21:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:22:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:23:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayFilterLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:38:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:39:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:40:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:41:50");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:42:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-filter.tq:43:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
void FastArrayFilter_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, TNode<JSArray> p_output, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_1) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi, BoolT> block62(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi> block59(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi> block58(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi> block64(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/array-filter.tq", 107);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 214);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 221);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 222);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-filter.tq", 111);
  ...
  if (block43.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 268);
    ca_.Branch(tmp16, &block46, std::vector<compiler::Node*>{phi_bb43_6, phi_bb43_7}, &block47, std::vector<compiler::Node*>{phi_bb43_6, phi_bb43_7});
  }
  ...
  if (block47.is_used()) {
    ca_.Bind(&block47, &phi_bb47_6, &phi_bb47_7);
    {
      ...
      pos_stack.push_back({"src/objects/js-array.tq", 268});
  ...
  if (block46.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 269);
    ca_.Branch(tmp11, &block48, std::vector<compiler::Node*>{phi_bb46_6, phi_bb46_7}, &block49, std::vector<compiler::Node*>{phi_bb46_6, phi_bb46_7});
  }
  ...
  if (block48.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 270);
    ...
    ca_.Goto(&block51, phi_bb48_6, phi_bb48_7);
    if (label38.is_used()) {
      ca_.Bind(&label38);
      ca_.Goto(&block52, phi_bb48_6, phi_bb48_7);
    }
  }
  ...
  if (block52.is_used()) {
    ...
    ca_.Goto(&block36, phi_bb52_6, phi_bb52_7, tmp35);
  }
  ...
  if (block51.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 269);
    ca_.Goto(&block50, phi_bb51_6, phi_bb51_7);
  }
  ...
  if (block49.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 273);
    ca_.Branch(tmp12, &block53, std::vector<compiler::Node*>{phi_bb49_6, phi_bb49_7}, &block54, std::vector<compiler::Node*>{phi_bb49_6, phi_bb49_7});
  }
  ...
  if (block53.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 274);
    ...
    ca_.Goto(&block56, phi_bb53_6, phi_bb53_7);
    if (label39.is_used()) {
      ca_.Bind(&label39);
      ca_.Goto(&block57, phi_bb53_6, phi_bb53_7);
    }
  }
  ...
  if (block57.is_used()) {
    ...
    ca_.Goto(&block36, phi_bb57_6, phi_bb57_7, tmp35);
  }
  ...
  if (block56.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 273);
    ca_.Goto(&block55, phi_bb56_6, phi_bb56_7);
  }
  ...
  if (block54.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 278);
    tmp40 = CodeStubAssembler(state_).LoadMapElementsKind(TNode<Map>{tmp10});
    tmp41 = FromConstexpr_ElementsKind_constexpr_HOLEY_ELEMENTS_0(state_, ElementsKind::HOLEY_ELEMENTS);
    tmp42 = CodeStubAssembler(state_).ElementsKindEqual(TNode<Int32T>{tmp40}, TNode<Int32T>{tmp41});
    ca_.Branch(tmp42, &block60, std::vector<compiler::Node*>{phi_bb54_6, phi_bb54_7}, &block61, std::vector<compiler::Node*>{phi_bb54_6, phi_bb54_7});
  }
  ...
  if (block60.is_used()) {
    ...
    ca_.Goto(&block62, phi_bb60_6, phi_bb60_7, tmp43);
  }
  ...
  if (block61.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 279);
    tmp44 = CodeStubAssembler(state_).LoadMapElementsKind(TNode<Map>{tmp10});
    tmp45 = FromConstexpr_ElementsKind_constexpr_PACKED_ELEMENTS_0(state_, ElementsKind::PACKED_ELEMENTS);
    tmp46 = CodeStubAssembler(state_).ElementsKindEqual(TNode<Int32T>{tmp44}, TNode<Int32T>{tmp45});
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 278);
    ca_.Goto(&block62, phi_bb61_6, phi_bb61_7, tmp46);
  }
  ...
  if (block62.is_used()) {
    ca_.Bind(&block62, &phi_bb62_6, &phi_bb62_7, &phi_bb62_25);
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 277);
    ca_.Branch(phi_bb62_25, &block58, std::vector<compiler::Node*>{phi_bb62_6, phi_bb62_7}, &block59, std::vector<compiler::Node*>{phi_bb62_6, phi_bb62_7});
  }
  ...
  if (block59.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/js-array.tq", 277});
  ...
  if (block58.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 280);
    compiler::CodeAssemblerLabel label47(&ca_);
    CodeStubAssembler(state_).BuildAppendJSArray(ElementsKind::HOLEY_ELEMENTS, TNode<JSArray>{tmp35}, TNode<Object>{phi_bb24_24}, &label47);
    ca_.Goto(&block63, phi_bb58_6, phi_bb58_7);
    if (label47.is_used()) {
      ca_.Bind(&label47);
      ca_.Goto(&block64, phi_bb58_6, phi_bb58_7);
    }
  }
  ...
  if (block64.is_used()) {
    ...
    ca_.Goto(&block36, phi_bb64_6, phi_bb64_7, tmp35);
  }
  ...
  if (block63.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 273);
    ca_.Goto(&block55, phi_bb63_6, phi_bb63_7);
  }
  ...
  if (block55.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/js-array.tq", 269);
    ca_.Goto(&block50, phi_bb55_6, phi_bb55_7);
  }
  ...
  if (block50.is_used()) {
    ...
    ca_.Goto(&block35, phi_bb50_6, phi_bb50_7, tmp35);
  }
  ...
  if (block36.is_used()) {
    ...
    tmp48 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kFastCreateDataProperty), p_context, tmp8, phi_bb36_7, phi_bb24_24);
    ca_.SetSourcePosition("../../../src/builtins/array-filter.tq", 119);
  ...
  if (block35.is_used()) {
    ...
    tmp50 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb35_7}, TNode<Smi>{tmp49});
    ca_.SetSourcePosition("../../../src/builtins/array-filter.tq", 118);
    ca_.Goto(&block34, phi_bb35_6, tmp50, phi_bb35_15);
  }
  ...
  if (block11.is_used()) {
    ...
    tmp52 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb11_6}, TNode<Smi>{tmp51});
    ca_.Goto(&block10, tmp52, phi_bb11_7, tmp22, phi_bb11_15);
  }
...
TF_BUILTIN(ArrayFilter, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/array-filter.tq", 190);
