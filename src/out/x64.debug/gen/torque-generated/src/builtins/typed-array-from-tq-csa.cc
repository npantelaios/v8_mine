...
TF_BUILTIN(TypedArrayFrom, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, Object, UintPtrT, UintPtrT, UintPtrT> block64(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, Object, UintPtrT, UintPtrT, UintPtrT> block63(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 24);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 25);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 26);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 30);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 208);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 36);
    tmp8 = Undefined_0(state_);
    tmp9 = CodeStubAssembler(state_).TaggedNotEqual(TNode<Object>{tmp3}, TNode<HeapObject>{tmp8});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 37);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 38);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 57);
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 141);
    tmp18 = CodeStubAssembler(state_).ToObject_Inline(TNode<Context>{parameter0}, TNode<Object>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 144);
    tmp19 = GetLengthProperty_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp18});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 147);
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 154);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 81);
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 84);
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 88);
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 91);
  ...
  if (block30.is_used()) {
    ca_.Bind(&block30);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 106);
  ...
  if (block29.is_used()) {
    ca_.Bind(&block29);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 95);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 96);
    tmp33 = CodeStubAssembler(state_).SmiConstant(Builtin::kArrayPrototypeValues);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 94);
  ...
  if (block31.is_used()) {
    ca_.Bind(&block31);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 97);
    ca_.Goto(&block20, ca_.Uninitialized<UintPtrT>());
  }
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 103);
  ...
  if (block36.is_used()) {
    ca_.Bind(&block36);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 124);
    ca_.Goto(&block20, ca_.Uninitialized<UintPtrT>());
  }
  ...
  if (block35.is_used()) {
    ca_.Bind(&block35);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 108);
  ...
  if (block37.is_used()) {
    ca_.Bind(&block37);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 114);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 115);
    tmp45 = CodeStubAssembler(state_).SmiConstant(Builtin::kTypedArrayPrototypeValues);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 113);
  ...
  if (block39.is_used()) {
    ca_.Bind(&block39);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 116);
  ...
  if (block27.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 127);
  ...
  if (block20.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 131);
    tmp48 = ca_.CallStub<JSArray>(Builtins::CallableFor(ca_.isolate(), Builtin::kIterableToList), parameter0, tmp1, tmp14);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 133);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 60);
  ...
  if (block19.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 136);
    ca_.Goto(&block14, phi_bb19_11, phi_bb19_12);
  }

  if (block44.is_used()) {
    ca_.Bind(&block44);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 151);
  ...
  if (block43.is_used()) {
    ca_.Bind(&block43);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 53);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 159);
    tmp52 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{phi_bb14_11});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 163);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 165);
  ...
  if (block45.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 167);
  ...
  if (block47.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 169);
  ...
  if (block48.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 171);
  ...
  if (block46.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 175);
  ...
  if (block52.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-from.tq:175:64");
  ...
  if (block51.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 177);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 182);
  ...
  if (block57.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 193);
...
tmp68 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(3)).descriptor(), tmp62, parameter0, tmp53, phi_bb59_19, phi_bb59_22));
  ...
  if (block61.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 210);
  ...
  if (block62.is_used()) {
    ...
    tmp71 = kStoreSucceded_0(state_);
    tmp72 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp68}, TNode<Smi>{tmp71});
    ca_.Branch(tmp72, &block63, std::vector<compiler::Node*>{phi_bb62_11, phi_bb62_12, phi_bb62_19, phi_bb62_28, phi_bb62_32}, &block64, std::vector<compiler::Node*>{phi_bb62_11, phi_bb62_12, phi_bb62_19, phi_bb62_28, phi_bb62_32});
  }

  TNode<UintPtrT> phi_bb64_11;
  TNode<Object> phi_bb64_12;
  TNode<UintPtrT> phi_bb64_19;
  TNode<UintPtrT> phi_bb64_28;
  TNode<UintPtrT> phi_bb64_32;
  if (block64.is_used()) {
    ca_.Bind(&block64, &phi_bb64_11, &phi_bb64_12, &phi_bb64_19, &phi_bb64_28, &phi_bb64_32);
    {
  ...
  TNode<UintPtrT> phi_bb63_28;
  TNode<UintPtrT> phi_bb63_32;
  TNode<UintPtrT> tmp73;
  TNode<UintPtrT> tmp74;
  if (block63.is_used()) {
    ca_.Bind(&block63, &phi_bb63_11, &phi_bb63_12, &phi_bb63_19, &phi_bb63_28, &phi_bb63_32);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 182);
    tmp73 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp74 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb63_19}, TNode<UintPtrT>{tmp73});
    ca_.Goto(&block55, phi_bb63_11, phi_bb63_12, tmp74);
  }
  ...
  if (block54.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-from.tq", 206);
    arguments.PopAndReturn(tmp53);
  }
}
