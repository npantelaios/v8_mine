...
TNode<Oddball> ThisBooleanValue_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, const char* p_method) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 9);
    ...
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 8);
    tmp1 = UnsafeCast_Boolean_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 6);
    ca_.Goto(&block2);
  }
...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 18);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 22);
...
TF_BUILTIN(BooleanPrototypeToString, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 36);
...
TF_BUILTIN(BooleanPrototypeValueOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/boolean.tq", 43);
