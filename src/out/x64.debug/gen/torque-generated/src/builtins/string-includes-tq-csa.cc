...
TF_BUILTIN(StringPrototypeIncludes, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 14);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 15);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 19);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 23);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 24);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 35);
    tmp11 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp5});
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 38);
    StaticAssertStringLengthFitsSmi_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 39);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 43);
    tmp15 = ca_.CallStub<Smi>(Builtins::CallableFor(ca_.isolate(), Builtin::kStringIndexOf), parameter0, tmp5, tmp7, phi_bb4_10);
    ca_.SetSourcePosition("../../../src/builtins/string-includes.tq", 47);
