...
TNode<Number> ConvertAndClampRelativeIndex_0(compiler::CodeAssemblerState* state_, TNode<Number> p_index, TNode<Number> p_length) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 8);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 11);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 13);
...
TF_BUILTIN(ArrayPrototypeCopyWithin, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 21);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 34);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 38);
    tmp9 = ConvertAndClampRelativeIndex_0(state_, TNode<Number>{tmp8}, TNode<Number>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 43);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 44);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 49);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 57);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 59);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 65);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 73);
    tmp35 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtin::kHasProperty), parameter0, tmp0, phi_bb8_11);
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 76);
    tmp36 = True_0(state_);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 78);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 88);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 94);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-copywithin.tq", 98);
