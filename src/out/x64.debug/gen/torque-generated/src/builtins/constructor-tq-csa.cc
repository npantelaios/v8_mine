...
TF_BUILTIN(FastNewClosureBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 52);
    tmp0 = CodeStubAssembler(state_).LoadContextFromBaseline();
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 53);
...
TF_BUILTIN(FastNewFunctionContextEval, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 58);
...
TF_BUILTIN(FastNewFunctionContextFunction, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 63);
...
TF_BUILTIN(CreateRegExpLiteral, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 69);
...
TF_BUILTIN(CreateShallowArrayLiteral, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 77);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 79);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 83);
...
TF_BUILTIN(CreateEmptyArrayLiteral, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 90);
...
TF_BUILTIN(CreateShallowObjectLiteral, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 97);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = Cast_FeedbackVector_0(state_, TNode<HeapObject>{parameter1}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 99);
    compiler::CodeAssemblerLabel label3(&ca_);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 102);
...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 112);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 114);
    ...
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 115);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 117);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 119);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 123);
...
TF_BUILTIN(CreateEmptyLiteralObject, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 128);
...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 137);
    tmp0 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 138);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 143);
    ...
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 144);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 148);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 157);
    tmp8 = LoadTargetFromFrame_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 159);
    ...
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 158);
    tmp11 = UnsafeCast_JSPrimitiveWrapper_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp10});
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 160);
    ...
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 161);
...
TF_BUILTIN(GenericLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/constructor.tq", 167);
