...
TF_BUILTIN(ArrayFindLastIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 12);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 18);
    tmp2 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{parameter3}, TNode<Object>{phi_bb1_5});
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 22);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 25);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 26);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 33);
...
TNode<Number> FastArrayFindLastIndex_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_predicate, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 40);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 42);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 43);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 44);
    std::tie(tmp8, tmp9, tmp10, tmp11, tmp12, tmp13) = NewFastJSArrayWitness_0(state_, TNode<JSArray>{tmp6}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 48);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 52);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 49);
  ...
  if (block25.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 63);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 65);
  ...
  if (block37.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 66);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 73);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2, &phi_bb2_5);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 37);
...
TF_BUILTIN(ArrayPrototypeFindLastIndex, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 91);
    ca_.Goto(&block2);
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 93);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 98);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 102);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 105);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/array-findlastindex.tq", 108);
