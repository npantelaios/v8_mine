...
tmp11 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp10, tmp4));
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 36);
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 12);
    ca_.Goto(&block24);
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 42);
...
TF_BUILTIN(TypedArrayPrototypeReduceRight, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 61);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 74);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 76);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 72);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 67);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-reduceright.tq", 69);
