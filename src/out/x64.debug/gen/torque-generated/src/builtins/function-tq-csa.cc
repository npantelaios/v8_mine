...
TF_BUILTIN(FunctionPrototypeHasInstance, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 12);
...
void CheckAccessor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<DescriptorArray> p_array, int32_t p_index, TNode<Name> p_name, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 31);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 33);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 36);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 28);
    ca_.Goto(&block17);
  }
...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 47);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 104);
    ca_.Goto(&block2);
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 50);
    CodeStubAssembler(state_).Comment("Disallow binding of slow-mode functions");
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 51);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 57);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 59);
    ca_.Goto(&block2);
  }
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 62);
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 64);
    tmp16 = CodeStubAssembler(state_).LengthStringConstant();
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 63);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 66);
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 73);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 75);
    tmp21 = BOUND_FUNCTION_WITH_CONSTRUCTOR_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 74);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 76);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 81);
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 85);
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 86);
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 88);
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 87);
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 90);
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 94);
    tmp45 = kEmptyFixedArray_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 95);
    tmp46 = kEmptyFixedArray_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 92);
    ...
    ca_.SetSourcePosition("../../../src/builtins/function.tq", 100);
