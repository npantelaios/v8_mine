...
TF_BUILTIN(GetIteratorWithFeedback, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 59);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 60);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    {
      ...
      pos_stack.push_back({"src/builtins/iterator.tq", 58});
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 63);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 67);
    tmp6 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kLoadIC), parameter0, parameter1, tmp5, parameter2, ca_.UncheckedCast<FeedbackVector>(parameter4));
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 63);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 64);
    tmp7 = CodeStubAssembler(state_).IteratorSymbolConstant();
    tmp8 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{parameter1}, TNode<Object>{tmp7});
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 63);
  ...
  if (block6.is_used()) {
    ...
    tmp10 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kCallIteratorWithFeedback), parameter0, parameter1, phi_bb6_5, tmp9, parameter4);
...
TF_BUILTIN(GetIteratorBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 82);
    tmp0 = CodeStubAssembler(state_).LoadContextFromBaseline();
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 83);
    tmp1 = CodeStubAssembler(state_).LoadFeedbackVectorFromBaseline();
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 85);
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 87);
    tmp4 = CodeStubAssembler(state_).TaggedIndexToSmi(TNode<TaggedIndex>{parameter2});
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 88);
...
TF_BUILTIN(CreateAsyncFromSyncIteratorBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 96);
    tmp0 = CodeStubAssembler(state_).LoadContextFromBaseline();
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 97);
...
TNode<Object> GetLazyReceiver_0(compiler::CodeAssemblerState* state_, TNode<Object> p_receiver) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 100);
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(CallIteratorWithFeedback, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 112);
    compiler::CodeAssemblerLabel label4(&ca_);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 113);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 116);
    CodeStubAssembler(state_).Return(tmp5);
  }
}
...
void IteratorCloseOnException_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructIteratorRecord p_iterator) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 125);
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 130);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 134);
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 135);
    ca_.Goto(&block2);
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 123);
    ca_.Goto(&block2);
  }

  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/iterator.tq", 120);
    ca_.Goto(&block1);
  }
