...
void ThrowIfNotGlobal_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_searchValue) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 16);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 20);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 21);
    tmp4 = RequireObjectCoercible_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp3}, "String.prototype.replaceAll");
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 23);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 17);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 26);
    ca_.Branch(phi_bb2_2, &block6, std::vector<compiler::Node*>{}, &block7, std::vector<compiler::Node*>{});
  }

  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 27);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 12);
    ca_.Goto(&block8);
  }
...
TF_BUILTIN(StringPrototypeReplaceAll, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 38);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, "String.prototype.replaceAll");
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 41);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 48);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 49);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 58);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 60);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 77);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 81);
    tmp16 = CodeStubAssembler(state_).LoadStringLengthAsSmi(TNode<String>{tmp12});
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 84);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 98);
    tmp19 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 99);
    tmp20 = kEmptyString_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 100);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 101);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 105);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 110);
    tmp25 = UnsafeCast_Callable_0(state_, TNode<Context>{parameter0}, TNode<Object>{phi_bb13_6});
    tmp26 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 109);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 114);
    tmp29 = UnsafeCast_String_0(state_, TNode<Context>{parameter0}, TNode<Object>{phi_bb13_6});
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 121);
    tmp30 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb18_12}, TNode<Smi>{tmp16});
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 122);
  ...
  if (block19.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 140);
    tmp39 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb19_12}, TNode<Smi>{tmp16});
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 143);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 147);
  ...
  if (block20.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 152);
    tmp48 = StringBuiltinsAssembler(state_).SubString(TNode<String>{tmp11}, TNode<UintPtrT>{tmp45}, TNode<UintPtrT>{tmp47});
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 151);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-replaceall.tq", 158);
