...
TNode<JSObject> ObjectFromEntriesFastCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_iterable, compiler::CodeAssemblerLabel* label_IfSlow) {
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 28);
  ...
  if (block22.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 33);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 31);
    CodeStubAssembler(state_).CallRuntime(Runtime::kCreateDataProperty, p_context, tmp7, tmp11, tmp12);
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 30);
  ...
  if (block26.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 37);
    ca_.Goto(&block1);
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 34);
...
TF_BUILTIN(ObjectFromEntries, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 77);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    {
      ...
      pos_stack.push_back({"src/builtins/object-fromentries.tq", 61});
  ...
  if (block15.is_used()) {
    ...
    tmp21 = IteratorBuiltinsAssembler(state_).IteratorStep(TNode<Context>{parameter0}, TorqueStructIteratorRecord{TNode<JSReceiver>{tmp7}, TNode<Object>{tmp8}}, TNode<Map>{tmp6}, &label22);
    }
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 67);
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 68);
    ...
    std::tie(tmp29, tmp30) = LoadKeyValuePair_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp26}).Flatten();
    }
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 69);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 71);
    arguments.PopAndReturn(tmp5);
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 73);
    ...
    ca_.SetSourcePosition("../../../src/builtins/object-fromentries.tq", 74);
