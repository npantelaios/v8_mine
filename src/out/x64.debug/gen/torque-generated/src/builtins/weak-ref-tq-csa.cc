...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 22);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 32);
    ...
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 33);
    ...
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 40);
...
TF_BUILTIN(WeakRefDeref, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 47);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 48);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 52);
    ...
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 57);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 61);
    tmp7 = UnsafeCast_JSReceiver_OR_Symbol_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 60);
    CodeStubAssembler(state_).CallRuntime(Runtime::kJSWeakRefAddToKeptObjects, parameter0, tmp7);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 57);
    ca_.Goto(&block6);
  }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/weak-ref.tq", 63);
