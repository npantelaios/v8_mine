...
TNode<Object> RegExpPrototypeSearchBodyFast_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/regexp-search.tq", 12});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 15);
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 24);
    tmp3 = UnsafeCast_JSRegExp_0(state_, TNode<Context>{p_context}, TNode<Object>{p_regexp});
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 23);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 36);
    RegExpBuiltinsAssembler(state_).FastStoreLastIndex(TNode<JSRegExp>{p_regexp}, TNode<Smi>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 37);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 29);
    RegExpBuiltinsAssembler(state_).FastStoreLastIndex(TNode<JSRegExp>{p_regexp}, TNode<Smi>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 33);
    std::tie(tmp7, tmp8, tmp9) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp4}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 113);
    tmp10 = Convert_intptr_constexpr_int31_0(state_, RegExpMatchInfo::kFirstCaptureIndex);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 32);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 9);
    ca_.Goto(&block16, phi_bb1_3);
  }

  TNode<Object> phi_bb16_3;
    ca_.Bind(&block16, &phi_bb16_3);
  return TNode<Object>{phi_bb16_3};
}
...
TNode<BoolT> IsRegExpResult_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_execResult) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 47);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 45);
    ca_.Goto(&block8);
  }
...
TNode<Object> RegExpPrototypeSearchBodySlow_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 53);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 58);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 62);
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 66);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 67);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 71);
    tmp8 = Null_0(state_);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 76);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 77);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_3);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 50);
...
TF_BUILTIN(RegExpSearchFast, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 86);
...
TF_BUILTIN(RegExpPrototypeSearch, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/regexp-search.tq", 104);
