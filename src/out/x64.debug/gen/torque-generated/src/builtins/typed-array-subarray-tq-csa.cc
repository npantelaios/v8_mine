...
TF_BUILTIN(TypedArrayPrototypeSubArray, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 20);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 31);
    tmp5 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 26);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 39);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 44);
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 50);
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 59);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 64);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 70);
    std::tie(tmp27, tmp28) = TypedArrayBuiltinsAssembler(state_).GetTypedArrayElementsInfo(TNode<JSTypedArray>{tmp0}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 73);
  ...
  if (block29.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 77);
    tmp36 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{tmp29}, TNode<UintPtrT>{tmp35});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 85);
  ...
  if (block24.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-subarray.tq", 78);
