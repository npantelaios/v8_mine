...
TorqueStructFrameWithArgumentsInfo_0 GetFrameWithArgumentsInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/frame-arguments.tq", 48);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/frame-arguments.tq", 49);
    tmp3 = LoadFunctionFromFrame_0(state_, TNode<RawPtrT>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/frame-arguments.tq", 51);
