...
TF_BUILTIN(StringPrototypeIndexOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 14);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 15);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 19);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 29);
    tmp10 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp5});
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 32);
    StaticAssertStringLengthFitsSmi_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 33);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-indexof.tq", 37);
