...
TF_BUILTIN(StringPrototypeStartsWith, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-startswith.tq", 13);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-startswith.tq", 18);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-startswith.tq", 36);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/string-startswith.tq", 50);
