...
TF_BUILTIN(ProxyRevoke, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/proxy-revoke.tq", 13);
    ...
    ca_.SetSourcePosition("../../../src/builtins/proxy-revoke.tq", 19);
    tmp4 = CodeStubAssembler(state_).LoadReference<HeapObject>(CodeStubAssembler::Reference{tmp2, tmp3});
    ca_.SetSourcePosition("../../../src/builtins/proxy-revoke.tq", 20);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/proxy-revoke.tq", 26);
    tmp7 = Null_0(state_);
    CodeStubAssembler(state_).StoreReference<HeapObject>(CodeStubAssembler::Reference{tmp2, tmp3}, tmp7);
    ca_.SetSourcePosition("../../../src/builtins/proxy-revoke.tq", 29);
  ...
  if (block5.is_used()) {
    ...
    tmp13 = Null_0(state_);
    CodeStubAssembler(state_).StoreReference<HeapObject>(CodeStubAssembler::Reference{ca_.UncheckedCast<JSProxy>(tmp4), tmp12}, tmp13);
