...
TNode<IntPtrT> FromConstexpr_PromiseValueThunkOrReasonContextSlot_constexpr_kValueSlot_0(compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseValueThunkOrReasonContextSlot p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 11);
...
TNode<IntPtrT> FromConstexpr_PromiseFinallyContextSlot_constexpr_kOnFinallySlot_0(compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseFinallyContextSlot p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 18);
    tmp0 = ca_.IntPtrConstant(CastToUnderlyingTypeIfEnum(p_o));
    tmp1 = (TNode<IntPtrT>{tmp0});
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(PromiseValueThunkFinally, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 30);
    tmp1 = kValueSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 29);
...
TF_BUILTIN(PromiseThrowerFinally, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 35);
    tmp0 = (TNode<Context>{parameter0});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 37);
    tmp1 = kValueSlot_0(state_);
    std::tie(tmp2, tmp3) = ContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_0(state_, TNode<Context>{tmp0}, TNode<IntPtrT>{tmp1}).Flatten();
    tmp4 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp2, tmp3});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 38);
...
TNode<JSFunction> CreateThrowerFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_reason) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 44);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 49);
    tmp3 = kValueSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 48);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 51);
    tmp4 = STRICT_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 50);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 52);
    tmp8 = CodeStubAssembler(state_).PromiseThrowerFinallySharedFunConstant();
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 53);
...
TF_BUILTIN(PromiseCatchFinally, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 59);
    tmp0 = (TNode<Context>{parameter0});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 63);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 66);
    tmp5 = Undefined_0(state_);
    tmp6 = CodeStubAssembler(state_).Call(TNode<Context>{tmp0}, TNode<Object>{tmp4}, TNode<Object>{tmp5});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 70);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 73);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 76);
    tmp12 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kPromiseResolve), tmp0, tmp10, tmp6);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 79);
    ...
    tmp14 = CreateThrowerFunction_0(state_, TNode<Context>{tmp0}, TNode<NativeContext>{tmp13}, TNode<Object>{parameter2});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 83);
    tmp15 = InvokeThen_0(state_, TNode<Context>{tmp0}, TNode<NativeContext>{tmp13}, TNode<Object>{tmp12}, TNode<Object>{tmp14});
...
TNode<JSFunction> CreateValueThunkFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 89);
    tmp0 = FromConstexpr_intptr_constexpr_intptr_0(state_, PromiseBuiltins::PromiseValueThunkOrReasonContextSlot::kPromiseValueThunkOrReasonContextLength);
    tmp1 = AllocateSyntheticFunctionContext_1(state_, TNode<NativeContext>{p_nativeContext}, TNode<IntPtrT>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 88);
    tmp2 = (TNode<Context>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 94);
    tmp3 = kValueSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 93);
    ...
    tmp4 = STRICT_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 96);
    std::tie(tmp5, tmp6) = ContextSlot_NativeContext_NativeContext_Map_0(state_, TNode<NativeContext>{p_nativeContext}, TNode<IntPtrT>{tmp4}).Flatten();
    tmp7 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp5, tmp6});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 98);
    tmp8 = CodeStubAssembler(state_).PromiseValueThunkFinallySharedFunConstant();
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 99);
    tmp9 = CodeStubAssembler(state_).AllocateFunctionWithMapAndContext(TNode<Map>{tmp7}, TNode<SharedFunctionInfo>{tmp8}, TNode<Context>{tmp2});
...
TF_BUILTIN(PromiseThenFinally, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 106);
    tmp0 = (TNode<Context>{parameter0});
    ...
    std::tie(tmp8, tmp9) = ContextSlot_PromiseFinallyContext_PromiseFinallyContext_Constructor_0(state_, TNode<Context>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    tmp10 = CodeStubAssembler(state_).LoadReference<JSReceiver>(CodeStubAssembler::Reference{tmp8, tmp9});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 120);
    tmp11 = CodeStubAssembler(state_).IsConstructor(TNode<HeapObject>{tmp10});
    ca_.Branch(tmp11, &block1, std::vector<compiler::Node*>{}, &block2, std::vector<compiler::Node*>{});
  }
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 123);
    tmp12 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kPromiseResolve), tmp0, tmp10, tmp6);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 126);
    tmp13 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 127);
    tmp14 = CreateValueThunkFunction_0(state_, TNode<Context>{tmp0}, TNode<NativeContext>{tmp13}, TNode<Object>{parameter2});
...
TorqueStructPromiseFinallyFunctions_0 CreatePromiseFinallyFunctions_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<JSReceiver> p_onFinally, TNode<JSReceiver> p_constructor) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 142);
    ...
    tmp1 = AllocateSyntheticFunctionContext_1(state_, TNode<NativeContext>{p_nativeContext}, TNode<IntPtrT>{tmp0});
    tmp2 = (TNode<Context>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 146);
    tmp3 = kOnFinallySlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 145);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 148);
    tmp4 = kConstructorSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 147);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 150);
    tmp5 = STRICT_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 149);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 151);
    tmp9 = CodeStubAssembler(state_).PromiseThenFinallySharedFunConstant();
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 153);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 154);
...
TF_BUILTIN(PromisePrototypeFinally, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 175);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 176);
    tmp3 = UnsafeCast_NativeContext_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter0});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 177);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 179);
    tmp8 = UnsafeCast_Constructor_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp7});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 180);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 181);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 182);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 185);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 189);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 206);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 208);
    std::tie(tmp21, tmp22) = CreatePromiseFinallyFunctions_0(state_, TNode<Context>{parameter0}, TNode<NativeContext>{tmp3}, TNode<JSReceiver>{tmp19}, TNode<JSReceiver>{phi_bb8_6}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 206);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 220);
    tmp23 = InvokeThen_1(state_, TNode<Context>{parameter0}, TNode<NativeContext>{tmp3}, TNode<Object>{parameter1}, TNode<Object>{phi_bb14_8}, TNode<Object>{phi_bb14_9});
    ca_.SetSourcePosition("../../../src/builtins/promise-finally.tq", 219);
