...
TNode<Number> FindLastIndexAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength, TNode<JSReceiver> p_predicate, TNode<Object> p_thisArg) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 16);
    std::tie(tmp0, tmp1, tmp2) = NewAttachedJSTypedArrayWitness_0(state_, TNode<JSTypedArray>{p_attachedArrayAndLength.array}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 19);
...
tmp11 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp10, tmp4));
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 29);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 30);
    tmp12 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 26);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 37);
    tmp13 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{tmp4});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 38);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 41);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 42);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 49);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 12);
...
TF_BUILTIN(TypedArrayPrototypeFindLastIndex, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 62);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 73);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 64);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 75);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 67);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 71);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 68);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findlastindex.tq", 69);
