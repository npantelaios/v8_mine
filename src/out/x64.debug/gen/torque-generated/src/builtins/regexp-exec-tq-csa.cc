...
TNode<Object> RegExpPrototypeExecBodyFast_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-exec.tq", 9);
    ca_.Goto(&block2);
  }
...
TNode<Object> RegExpPrototypeExecBodySlow_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-exec.tq", 15);
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(RegExpPrototypeExecSlow, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-exec.tq", 24);
...
TF_BUILTIN(RegExpPrototypeExec, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-exec.tq", 35);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-exec.tq", 40);
