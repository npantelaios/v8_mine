...
TF_BUILTIN(StringPrototypeSubstr, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 14);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 17);
    tmp2 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 21);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 23);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 28);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 29);
    tmp11 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{tmp2}, TNode<UintPtrT>{phi_bb3_9});
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 30);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    {
      ...
      pos_stack.push_back({"src/builtins/string-substr.tq", 30});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 31);
    tmp13 = Undefined_0(state_);
    tmp14 = CodeStubAssembler(state_).TaggedNotEqual(TNode<Object>{tmp10}, TNode<HeapObject>{tmp13});
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 32);
    tmp15 = ClampToIndexRange_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp10}, TNode<UintPtrT>{tmp11});
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 31);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 36);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/string-substr.tq", 40);
