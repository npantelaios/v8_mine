...
TF_BUILTIN(StringPrototypeMatch, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 75);
...
TF_BUILTIN(StringPrototypeSearch, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 83);
...
TNode<Object> StringMatchSearch_StringMatchFunctor_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_receiver, TNode<Object> p_regexp, TorqueStructStringMatchFunctor_0 p_functor, const char* p_methodName) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 37);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{p_context}, TNode<Object>{p_receiver}, p_methodName);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 41);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 42);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 12);
    tmp5 = IsFastRegExpForMatch_0(state_, TNode<Context>{p_context}, TNode<HeapObject>{tmp3});
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 43);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 45);
    tmp7 = UnsafeCast_FastJSRegExp_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp3});
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 16);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 48);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 9);
    tmp14 = CodeStubAssembler(state_).MatchSymbolConstant();
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 52);
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 55);
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 60);
    tmp18 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{p_context}, TNode<Object>{p_receiver});
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 63);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 66);
    tmp22 = CodeStubAssembler(state_).GetProperty(TNode<Context>{p_context}, TNode<Object>{tmp20}, TNode<Object>{tmp21});
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 67);
...
TNode<Object> StringMatchSearch_StringSearchFunctor_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_receiver, TNode<Object> p_regexp, TorqueStructStringSearchFunctor_0 p_functor, const char* p_methodName) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 25);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 45);
    tmp7 = UnsafeCast_FastJSRegExp_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp3});
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 29);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/string-match-search.tq", 22);
