...
TF_BUILTIN(TypedArrayOf, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT> block15(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 17);
    tmp0 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{torque_arguments.length});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 23);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 49);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 27);
    tmp3 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 26);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 30);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 34);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 36);
...
tmp13 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(3)).descriptor(), tmp8, parameter0, tmp4, phi_bb7_12, tmp12));
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 51);
  ...
  if (block13.is_used()) {
    ...
    tmp16 = kStoreSucceded_0(state_);
    tmp17 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp13}, TNode<Smi>{tmp16});
    ca_.Branch(tmp17, &block14, std::vector<compiler::Node*>{phi_bb13_12, phi_bb13_19, phi_bb13_23}, &block15, std::vector<compiler::Node*>{phi_bb13_12, phi_bb13_19, phi_bb13_23});
  }

  TNode<UintPtrT> phi_bb15_12;
  TNode<UintPtrT> phi_bb15_19;
  TNode<UintPtrT> phi_bb15_23;
  if (block15.is_used()) {
    ca_.Bind(&block15, &phi_bb15_12, &phi_bb15_19, &phi_bb15_23);
    {
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14, &phi_bb14_12, &phi_bb14_19, &phi_bb14_23);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 34);
    tmp18 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp19 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb14_12}, TNode<UintPtrT>{tmp18});
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-of.tq", 47);
