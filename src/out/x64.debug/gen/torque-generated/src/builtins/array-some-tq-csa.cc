...
TF_BUILTIN(ArraySomeLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:17:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:18:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:19:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:20:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArraySomeLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:35:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:36:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:37:50");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:38:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArraySomeLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 59);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 65);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 68);
    tmp2 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 76);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 83);
...
TNode<Object> FastArraySome_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 89);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 95);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 107);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 86);
...
TF_BUILTIN(ArraySome, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 127);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 130);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 134);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 138);
    tmp14 = Undefined_0(state_);
    tmp15 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 137);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/array-some.tq", 141);
