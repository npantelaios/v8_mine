...
TF_BUILTIN(SymbolPrototypeToPrimitive, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/symbol.tq", 29);
...
TF_BUILTIN(SymbolPrototypeValueOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/symbol.tq", 45);
