...
TF_BUILTIN(RegExpPrototypeTest, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/regexp-test.tq", 22);
    tmp8 = True_0(state_);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/regexp-test.tq", 25);
    tmp10 = Null_0(state_);
...
TF_BUILTIN(RegExpPrototypeTestFast, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/regexp-test.tq", 30);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/regexp-test.tq", 31);
    tmp2 = False_0(state_);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/regexp-test.tq", 32);
    tmp3 = True_0(state_);
