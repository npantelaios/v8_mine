...
TF_BUILTIN(ArrayReduceRightPreLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:17:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:18:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:19:55");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 20);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 26);
...
TF_BUILTIN(ArrayReduceRightLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:41:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:42:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:43:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 44);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:44:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayReduceRightLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:57:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:58:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:59:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 60);
    compiler::CodeAssemblerLabel label7(&ca_);
    tmp6 = Cast_Number_0(state_, TNode<Object>{parameter4}, &label7);
    ca_.Goto(&block15);
    if (label7.is_used()) {
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-reduce-right.tq:60:55");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block15.is_used()) {
    ...
    tmp8 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceRightLoopContinuation), parameter0, tmp0, tmp2, parameter5, tmp0, tmp4, tmp6);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 65);
    CodeStubAssembler(state_).Return(tmp8);
  }
}
...
TF_BUILTIN(ArrayReduceRightLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 76);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 82);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 85);
    tmp3 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 87);
    tmp5 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{parameter4}, TNode<Object>{phi_bb5_8});
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 90);
    compiler::CodeAssemblerLabel label7(&ca_);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 115);
...
TNode<Object> FastArrayReduceRight_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 128);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 135);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 132);
  ...
  if (block38.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 144);
  ...
  if (block43.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 120);
    ca_.Goto(&block44);
  }
  ...
  if (block42.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 151);
...
TF_BUILTIN(ArrayReduceRight, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 177);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 184);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reduce-right.tq", 187);
