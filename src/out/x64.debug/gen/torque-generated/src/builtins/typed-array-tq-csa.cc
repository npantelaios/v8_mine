...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_elementsKindParam) {
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array.tq:176:3");
...
ElementsKind KindForArrayType_Uint32Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array.tq", 265);
    ca_.Goto(&block2);
  }
...
ElementsKind KindForArrayType_BigUint64Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array.tq", 280);
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(StoreTypedElementJSAny_Int32Elements_0, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/typed-array.tq", 312);
