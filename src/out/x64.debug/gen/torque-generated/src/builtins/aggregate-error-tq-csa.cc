...
USE(parameter2);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/aggregate-error.tq", 21);
    ...
    ca_.SetSourcePosition("../../../src/builtins/aggregate-error.tq", 22);
    ...
    ca_.SetSourcePosition("../../../src/builtins/aggregate-error.tq", 23);
    ...
    ca_.SetSourcePosition("../../../src/builtins/aggregate-error.tq", 27);
