...
TF_BUILTIN(PromiseResolveThenableJob, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 25);
    tmp0 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{parameter0});
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 26);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 27);
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    tmp6 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{parameter2, tmp5});
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 28);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 29);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 30);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 59);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 60);
    tmp17 = CodeStubAssembler(state_).UndefinedConstant();
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 58);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 63);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 68);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 67);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-jobs.tq", 70);
