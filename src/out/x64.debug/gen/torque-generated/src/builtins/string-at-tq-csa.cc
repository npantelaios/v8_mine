...
TF_BUILTIN(StringPrototypeAt, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 11);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 13);
    tmp2 = CodeStubAssembler(state_).LoadStringLengthAsSmi(TNode<String>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 15);
    tmp3 = ToInteger_Inline_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter2});
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 20);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 22);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 23);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-at.tq", 27);
