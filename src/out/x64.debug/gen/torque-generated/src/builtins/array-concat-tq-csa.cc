...
TF_BUILTIN(ArrayPrototypeConcat, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 13);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 15);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 16);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 27);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 25);
    ca_.Goto(&block7);
  }
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 29);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 30);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 31);
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 32);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 39);
    ca_.Goto(&block7);
  }
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 45);
    tmp16 = LoadTargetFromFrame_0(state_);
    tmp17 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 46);
    tmp18 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{torque_arguments.actual_count});
    ca_.SetSourcePosition("../../../src/builtins/array-concat.tq", 44);
