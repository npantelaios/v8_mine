...
TF_BUILTIN(TypedArrayPrototypeToSorted, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 15);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 16);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 17);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 26);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 50);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 49);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-to-sorted.tq:49:47");
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 51);
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 53);
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-sorted.tq", 57);
