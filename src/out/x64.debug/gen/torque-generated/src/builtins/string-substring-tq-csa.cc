...
TF_BUILTIN(StringPrototypeSubstring, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substring.tq", 19);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substring.tq", 21);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-substring.tq", 27);
