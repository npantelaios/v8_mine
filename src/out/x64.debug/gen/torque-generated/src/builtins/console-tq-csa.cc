...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/console.tq", 12);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/console.tq", 13);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/console.tq", 16);
    tmp4 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{torque_arguments.actual_count});
    ca_.SetSourcePosition("../../../src/builtins/console.tq", 15);
