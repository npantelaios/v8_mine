...
TNode<BoolT> IsPromiseSpeciesLookupChainIntact_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_nativeContext, TNode<Map> p_promiseMap) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 21);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 22);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 23);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 24);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 17);
...
TF_BUILTIN(PromisePrototypeThen, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 33);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 38);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 44);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 45);
    ca_.Goto(&block6);
  }
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 50);
    ca_.Goto(&block6);
  }
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 52);
    tmp12 = True_0(state_);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 54);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 56);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 57);
    tmp16 = NewJSPromise_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 43);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 69);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 73);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 77);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 83);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 84);
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    ca_.SetSourcePosition("../../../src/builtins/promise-then.tq", 87);
...
TNode<HeapObject> CastOrDefault_Callable_JSAny_Undefined_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_x, TNode<Oddball> p_default) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/cast.tq", 836);
    compiler::CodeAssemblerLabel label1(&ca_);
