...
TF_BUILTIN(StringPrototypeSlice, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-slice.tq", 12);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-slice.tq", 20);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-slice.tq", 24);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-slice.tq", 28);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/string-slice.tq", 32);
