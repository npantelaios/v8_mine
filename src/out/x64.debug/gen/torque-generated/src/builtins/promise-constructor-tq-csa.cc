...
TNode<BoolT> HasAccessCheckFailed_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_promiseFun, TNode<Object> p_executor) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 34);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 35);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 36);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 31);
    ca_.Goto(&block6);
  }
...
USE(parameter2);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 53);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 57);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 58);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 61);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 64);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 66);
    tmp9 = CodeStubAssembler(state_).SmiConstant(v8::Isolate::kPromiseConstructorReturnedUndefined);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 65);
    CodeStubAssembler(state_).CallRuntime(Runtime::kIncrementUseCounter, parameter0, tmp9);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 67);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 71);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 72);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 75);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 74);
    tmp14 = UnsafeCast_JSPromise_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp13});
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 76);
    PromiseInit_0(state_, TNode<JSPromise>{tmp14});
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 77);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 80);
    tmp16 = CodeStubAssembler(state_).IsDebugActive();
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 81);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 83);
    tmp18 = True_0(state_);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 87);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 88);
    ca_.Goto(&block12);
  }
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 89);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 86);
    ca_.Goto(&block12);
  }

  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 92);
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 93);
...
TF_BUILTIN(PromisePrototypeCatch, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 105);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 106);
    tmp1 = UnsafeCast_NativeContext_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter0});
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 108);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-constructor.tq", 107);
