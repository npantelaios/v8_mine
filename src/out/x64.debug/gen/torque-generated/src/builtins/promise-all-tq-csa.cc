...
TNode<Context> CreatePromiseAllResolveElementContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<PromiseCapability> p_capability, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 23);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 22);
    tmp2 = (TNode<Context>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 28);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 33);
    tmp4 = kPromiseAllResolveElementCapabilitySlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 31);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 38);
...
TNode<JSFunction> CreatePromiseAllResolveElementFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Context> p_resolveElementContext, TNode<Smi> p_index, TNode<NativeContext> p_nativeContext, TNode<SharedFunctionInfo> p_resolveFunction) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 47);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/promise-all.tq", 47});
  ...
  if (block5.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-all.tq", 48});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 51);
    tmp4 = STRICT_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 50);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 52);
    tmp8 = CodeStubAssembler(state_).AllocateFunctionWithMapAndContext(TNode<Map>{tmp7}, TNode<SharedFunctionInfo>{p_resolveFunction}, TNode<Context>{p_resolveElementContext});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 55);
    tmp9 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(PropertyArray::kNoHashSentinel, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))))));
  ...
  if (block7.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-all.tq", 55});
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 56);
    tmp10 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp8, tmp10}, p_index);
...
TNode<Context> CreatePromiseResolvingFunctionsContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Oddball> p_debugEvent, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = AllocateSyntheticFunctionContext_1(state_, TNode<NativeContext>{p_nativeContext}, TNode<IntPtrT>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 64);
    tmp2 = (TNode<Context>{tmp1});
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 73);
    tmp5 = False_0(state_);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 75);
    tmp6 = kDebugEventSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 74);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 78);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 77);
...
TNode<BoolT> IsPromiseThenLookupChainIntact_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Map> p_receiverMap) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 85);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 86);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 87);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 88);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 91);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 83);
...
TF_BUILTIN(PromiseAll, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 378);
...
TF_BUILTIN(PromiseAllSettled, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 387);
...
TNode<Object> GeneratePromiseAll_PromiseAllResolveElementFunctor_PromiseAllRejectElementFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<Object> p_iterable, TorqueStructPromiseAllResolveElementFunctor_0 p_createResolveElementFunctor, TorqueStructPromiseAllRejectElementFunctor_0 p_createRejectElementFunctor, const char* p_message, bool p_hasResolveAndRejectClosures) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Object, HeapObject> block11(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 331);
    tmp0 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{p_context});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 334);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 335);
  ...
  if (block7.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-all.tq", 343});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 354);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 361);
  ...
  TNode<HeapObject> phi_bb11_8;
  if (block11.is_used()) {
    ca_.Bind(&block11, &phi_bb11_7, &phi_bb11_8);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 367);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 369);
    tmp22 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp23 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp4, tmp22});
    tmp24 = UnsafeCast_JSAny_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp23});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 370);
    tmp25 = Undefined_0(state_);
    tmp26 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<Object>{tmp24}, TNode<Object>{tmp25}, TNode<Object>{phi_bb9_7});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 371);
...
TNode<Object> PerformPromiseAll_PromiseAllResolveElementFunctor_PromiseAllRejectElementFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iter, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_capability, TNode<Object> p_promiseResolveFunction, TorqueStructPromiseAllResolveElementFunctor_0 p_createResolveElementFunctor, TorqueStructPromiseAllRejectElementFunctor_0 p_createRejectElementFunctor, bool p_hasResolveAndRejectClosures, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 145);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 146);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 150);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 155);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 161);
    tmp12 = ITERATOR_RESULT_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 160);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 162);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 168);
  ...
  if (block19.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 159);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 175);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 181);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 177);
  ...
  if (block22.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 190);
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 198);
    tmp47 = kPromiseAllResolveElementRemainingSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 196);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 101);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 110);
  ...
  if (block52.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 238);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 237);
  ...
  if (block33.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 242);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 246);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 247);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 253);
  ...
  if (block63.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 254);
  ...
  if (block34.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 258);
  ...
  if (block59.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 264);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 269);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 274);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 279);
  ...
  if (block76.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 281);
  ...
  if (block78.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 287);
    tmp173 = kPromiseAllResolveElementValuesSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 285);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 289);
    tmp176 = CodeStubAssembler(state_).LoadReference<FixedArray>(CodeStubAssembler::Reference{tmp174, tmp175});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 292);
  ...
  if (block81.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 296);
  ...
  if (block79.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 307);
    tmp184 = kPromiseAllResolveElementValuesSlot_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 305);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 311);
    tmp188 = JS_ARRAY_PACKED_ELEMENTS_MAP_INDEX_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 310);
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 316);
  ...
  if (block84.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 319);
...
TNode<Object> PerformPromiseAll_PromiseAllSettledResolveElementFunctor_PromiseAllSettledRejectElementFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iter, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_capability, TNode<Object> p_promiseResolveFunction, TorqueStructPromiseAllSettledResolveElementFunctor_0 p_createResolveElementFunctor, TorqueStructPromiseAllSettledRejectElementFunctor_0 p_createRejectElementFunctor, bool p_hasResolveAndRejectClosures, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0) {
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 119);
    tmp60 = CreatePromiseAllResolveElementFunction_0(state_, TNode<Context>{p_context}, TNode<Context>{tmp10}, TNode<Smi>{phi_bb23_11}, TNode<NativeContext>{p_nativeContext}, TNode<SharedFunctionInfo>{tmp59});
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 132);
    tmp61 = CodeStubAssembler(state_).PromiseAllSettledRejectElementSharedFunConstant();
    ca_.SetSourcePosition("../../../src/builtins/promise-all.tq", 130);
