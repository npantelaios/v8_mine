...
TF_BUILTIN(StringPrototypeIsWellFormed, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 24);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 30);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 37);
    tmp5 = Flatten_0(state_, TNode<String>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 39);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 42);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/string-iswellformed.tq", 40);
