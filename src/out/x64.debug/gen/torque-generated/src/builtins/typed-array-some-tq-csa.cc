...
tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp8, phi_bb14_8));
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 29);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 30);
    tmp10 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 26);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 38);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 11);
...
TF_BUILTIN(TypedArrayPrototypeSome, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 63);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 72);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 65);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 74);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 68);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 76);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 69);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-some.tq", 70);
