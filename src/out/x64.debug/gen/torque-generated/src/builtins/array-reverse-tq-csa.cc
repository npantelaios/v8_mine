...
void StoreElement_FixedArray_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TNode<Object> p_value) {
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 25);
    ca_.Goto(&block10);
  }
...
void StoreElement_FixedDoubleArray_float64_or_hole_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TorqueStructfloat64_or_hole_0 p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 33);
    tmp0 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<Object>{p_elements});
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 34);
    std::tie(tmp1, tmp2, tmp3) = FieldSliceFixedDoubleArrayFloats_0(state_, TNode<FixedDoubleArray>{tmp0}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 118);
    tmp4 = Convert_intptr_Smi_0(state_, TNode<Smi>{p_index});
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 89);
...
TNode<Object> GenericArrayReverse_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 70);
    tmp2 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 71);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 74);
    tmp6 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 75);
    tmp7 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 80);
    tmp8 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtin::kHasProperty), p_context, tmp0, phi_bb2_4);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 83);
    tmp9 = True_0(state_);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 85);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 94);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 100);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 104);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 115);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 119);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 120);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 55);
    ca_.Goto(&block26);
  }
...
void TryFastPackedArrayReverse_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 129);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 131);
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 132);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 134);
    EnsureWriteableFastElements_0(state_, TNode<Context>{p_context}, TNode<JSArray>{tmp0});
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 135);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 136);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 140);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 141);
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 143);
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 144);
  ...
  if (block24.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 148);
...
TF_BUILTIN(ArrayPrototypeReverse, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 163);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 161);
...
void FastArrayReverse_FixedArray_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 42);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/array-reverse.tq", 49);
