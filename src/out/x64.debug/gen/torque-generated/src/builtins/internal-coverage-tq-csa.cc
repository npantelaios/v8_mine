...
TNode<CoverageInfo> GetCoverageInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSFunction> p_function, compiler::CodeAssemblerLabel* label_IfNoCoverageInfo) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 11);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp1 = CodeStubAssembler(state_).LoadReference<SharedFunctionInfo>(CodeStubAssembler::Reference{p_function, tmp0});
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 12);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 13);
    ca_.Goto(&block1);
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 15);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 16);
    ...
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 9);
    ca_.Goto(&block9);
  }
...
void IncrementBlockCount_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<CoverageInfo> p_coverageInfo, TNode<Smi> p_slot) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/internal-coverage.tq", 21});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 22);
  ...
  if (block8.is_used()) {
    ...
    std::tie(tmp13, tmp14) = NewReference_CoverageInfoSlot_0(state_, TNode<Object>{tmp4}, TNode<IntPtrT>{tmp12}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 22);
    ...
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 19);
    ca_.Goto(&block12);
  }
...
TF_BUILTIN(IncBlockCounter, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/builtins/internal-coverage.tq", 35);
...
TNode<CoverageInfo> UnsafeCast_CoverageInfo_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = Is_CoverageInfo_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
