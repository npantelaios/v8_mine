...
TNode<BoolT> IsSubstringAt_0(compiler::CodeAssemblerState* state_, TNode<String> p_string, TNode<String> p_searchStr, TNode<IntPtrT> p_start) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 35);
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(StringPrototypeEndsWith, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 50);
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 54);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 59);
    tmp7 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{parameter0}, TNode<Object>{tmp1});
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 62);
    tmp8 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp5});
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 68);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 71);
    tmp12 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp7});
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 74);
...
TNode<BoolT> IsSubstringAt_char8_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr, TNode<IntPtrT> p_start) {
  ...
  if (block23.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 16);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/string-endswith.tq", 21);
    VerifiedUnreachable_0(state_);
  }
