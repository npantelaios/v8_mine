...
TF_BUILTIN(TypedArrayPrototypeToReversed, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 12);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 22);
    tmp7 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 25);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 28);
...
tmp13 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(2)).descriptor(), tmp5, parameter0, tmp2, phi_bb1_12, tmp12));
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 37);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-to-reversed.tq", 41);
