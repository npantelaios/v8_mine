...
tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp8, phi_bb14_8));
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 29);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 30);
    tmp10 = Undefined_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 26);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 38);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 11);
...
TF_BUILTIN(TypedArrayPrototypeFindIndex, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 57);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 68);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 59);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 70);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 62);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 66);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 63);
    ...
    ca_.SetSourcePosition("../../../src/builtins/typed-array-findindex.tq", 64);
