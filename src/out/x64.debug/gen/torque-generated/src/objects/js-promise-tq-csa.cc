...
TNode<JSPromise> Cast_JSPromise_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 13);
...
TNode<Object> LoadJSPromiseReactionsOrResult_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 35);
...
TNode<Smi> LoadJSPromiseFlags_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 36);
...
TNode<Int32T> Method_JSPromise_Status_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 15);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    ...
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 14);
    ca_.Goto(&block2);
  }
...
void Method_JSPromise_SetStatus_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this, Promise::PromiseState p_status) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 19);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 20);
    tmp3 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31NotEqual(p_status, Promise::PromiseState::kPending)));
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 22);
    ...
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 18);
    ca_.Goto(&block6);
  }
...
TNode<BoolT> Method_JSPromise_HasHandler_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 26);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp1 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_this, tmp0});
    ...
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 25);
    ca_.Goto(&block2);
  }
...
void Method_JSPromise_SetHasHandler_0(compiler::CodeAssemblerState* state_, TNode<JSPromise> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 30);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp1 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_this, tmp0});
    ...
    ca_.SetSourcePosition("../../../src/objects/js-promise.tq", 29);
    ca_.Goto(&block2);
  }
