...
TNode<AlwaysSharedSpaceJSObject> Cast_AlwaysSharedSpaceJSObject_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-struct.tq", 8);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-struct.tq?l=13&c=1
TNode<JSSharedStruct> Cast_JSSharedStruct_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-struct.tq", 13);
    compiler::CodeAssemblerLabel label1(&ca_);
...
TNode<AlwaysSharedSpaceJSObject> DownCastForTorqueClass_AlwaysSharedSpaceJSObject_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ...
    if (((CodeStubAssembler(state_).ConstexprInt31Equal(static_cast<InstanceType>(2151), static_cast<InstanceType>(2154))))) {
      ca_.Goto(&block3);
    } else {
      ca_.Goto(&block4);
    }
  ...
  if (block4.is_used()) {
    ...
    tmp8 = FromConstexpr_int32_constexpr_int32_0(state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(2154), static_cast<InstanceType>(2151))));
