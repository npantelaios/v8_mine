...
TNode<Uint64T> kByteMaskShift_0(compiler::CodeAssemblerState* state_) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 52);
  TNode<Uint64T> tmp0;
...
TNode<Uint32T> H1_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_hash) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 94);
    ...
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 93);
    ca_.Goto(&block2);
  }
...
TNode<Uint32T> H2_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_hash) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 98);
    ...
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 97);
    ca_.Goto(&block2);
  }
...
TNode<Uint64T> ClearLowestSetBit_uint64_0(compiler::CodeAssemblerState* state_, TNode<Uint64T> p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/swiss-hash-table-helpers.tq", 49);
