...
TNode<BigInt> Cast_BigIntBase_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/bigint.tq", 7);
...
TNode<BigInt> Convert_BigInt_MutableBigInt_0(compiler::CodeAssemblerState* state_, TNode<BigInt> p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/bigint.tq", 17);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/objects/bigint.tq", 17});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/bigint.tq", 18);
    tmp1 = Convert_BigIntBase_MutableBigInt_0(state_, TNode<BigInt>{p_i});
    tmp2 = (TNode<BigInt>{tmp1});
    ca_.SetSourcePosition("../../../src/objects/bigint.tq", 16);
    ca_.Goto(&block4);
  }
