...
TNode<JSProxy> Cast_JSProxy_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 5);
...
TNode<JSObject> NewJSProxyRevocableResult_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSProxy> p_proxy, TNode<JSFunction> p_revoke) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 18);
    tmp0 = GetProxyRevocableResultMap_0(state_, TNode<Context>{p_context});
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 19);
    tmp1 = kEmptyFixedArray_0(state_);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 20);
    tmp2 = kEmptyFixedArray_0(state_);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 17);
    ...
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 15);
    ca_.Goto(&block2);
  }
...
TNode<HeapObject> LoadJSProxyTarget_0(compiler::CodeAssemblerState* state_, TNode<JSProxy> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 6);
...
TNode<HeapObject> LoadJSProxyHandler_0(compiler::CodeAssemblerState* state_, TNode<JSProxy> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 7);
...
TNode<Object> LoadJSProxyRevocableResultProxy_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 11);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
...
TNode<Object> LoadJSProxyRevocableResultRevoke_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/js-proxy.tq", 12);
