...
TNode<String> Cast_String_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 7);
...
TNode<Uint32T> FromConstexpr_StringRepresentationTag_constexpr_kSeqStringTag_0(compiler::CodeAssemblerState* state_, StringRepresentationTag p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 22);
...
TNode<SeqOneByteString> AllocateNonEmptySeqOneByteString_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 157);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 156);
    ca_.Goto(&block2);
  }
...
TNode<SeqTwoByteString> AllocateNonEmptySeqTwoByteString_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 160);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 159);
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(StringSlowFlatten, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<ConsString> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString, BoolT> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block16(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<ConsString, String> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);

  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 194);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 199);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 200);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 203);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 208);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 209);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 210);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 215);
    ...
    tmp31 = CodeStubAssembler(state_).TaggedToHeapObject(TNode<Object>{tmp30}, &label32);
    ca_.Goto(&block21, phi_bb11_1);
    if (label32.is_used()) {
      ca_.Bind(&label32);
      ca_.Goto(&block22, phi_bb11_1);
    }
  }

  TNode<ConsString> phi_bb22_1;
  if (block22.is_used()) {
    ca_.Bind(&block22, &phi_bb22_1);
    ca_.Goto(&block19, phi_bb22_1);
  }

  TNode<ConsString> phi_bb21_1;
  TNode<SeqTwoByteString> tmp33;
  if (block21.is_used()) {
    ca_.Bind(&block21, &phi_bb21_1);
    compiler::CodeAssemblerLabel label34(&ca_);
    tmp33 = Cast_SeqTwoByteString_0(state_, TNode<HeapObject>{tmp31}, &label34);
    ca_.Goto(&block23, phi_bb21_1);
    if (label34.is_used()) {
      ca_.Bind(&label34);
      ca_.Goto(&block24, phi_bb21_1);
    }
  }

  TNode<ConsString> phi_bb24_1;
  if (block24.is_used()) {
    ca_.Bind(&block24, &phi_bb24_1);
    ca_.Goto(&block19, phi_bb24_1);
  }

  TNode<ConsString> phi_bb23_1;
  TNode<BoolT> tmp35;
  if (block23.is_used()) {
    ca_.Bind(&block23, &phi_bb23_1);
    ca_.SetSourcePosition("../../../src/builtins/cast.tq", 809);
    tmp35 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Goto(&block17, phi_bb23_1, tmp35);
  }

  TNode<ConsString> phi_bb19_1;
  TNode<BoolT> tmp36;
  if (block19.is_used()) {
    ...
    ca_.Goto(&block17, phi_bb19_1, tmp36);
  }

  TNode<ConsString> phi_bb17_1;
  TNode<BoolT> phi_bb17_7;
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_1, &phi_bb17_7);
    ca_.SetSourcePosition("../../../src/builtins/cast.tq", 814);
    ca_.Branch(phi_bb17_7, &block15, std::vector<compiler::Node*>{phi_bb17_1}, &block16, std::vector<compiler::Node*>{phi_bb17_1});
  }

  TNode<ConsString> phi_bb16_1;
  if (block16.is_used()) {
    ca_.Bind(&block16, &phi_bb16_1);
    {
  ...
  TNode<ConsString> phi_bb15_1;
  TNode<SeqTwoByteString> tmp37;
  TNode<Object> tmp38;
  TNode<IntPtrT> tmp39;
  TNode<IntPtrT> tmp40;
  TNode<RawPtrT> tmp41;
  ...
  TNode<Int32T> tmp45;
  if (block15.is_used()) {
    ca_.Bind(&block15, &phi_bb15_1);
    ca_.SetSourcePosition("../../../src/builtins/cast.tq", 815);
    tmp37 = TORQUE_CAST(TNode<Object>{tmp30});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 217);
    std::tie(tmp38, tmp39, tmp40) = FieldSliceSeqTwoByteStringChars_0(state_, TNode<SeqTwoByteString>{tmp37}).Flatten();
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 154);
    tmp41 = CodeStubAssembler(state_).GCUnsafeReferenceToRawPtr(TNode<Object>{tmp38}, TNode<IntPtrT>{tmp39});
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 153);
    tmp42 = (TNode<RawPtrT>{tmp41});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 217);
    tmp43 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp44 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{phi_bb15_1, tmp43});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 216);
    tmp45 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    CodeStubAssembler(state_).StringWriteToFlatTwoByte(TNode<String>{phi_bb15_1}, TNode<RawPtrT>{tmp42}, TNode<Int32T>{tmp45}, TNode<Int32T>{tmp44});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 208);
    ca_.Goto(&block12, phi_bb15_1, tmp37);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 220);
    tmp46 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    CodeStubAssembler(state_).StoreReference<String>(CodeStubAssembler::Reference{phi_bb12_1, tmp46}, phi_bb12_2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 221);
    tmp47 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp48 = kEmptyString_0(state_);
    CodeStubAssembler(state_).StoreReference<String>(CodeStubAssembler::Reference{phi_bb12_1, tmp47}, tmp48);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 222);
...
TNode<String> Flatten_0(compiler::CodeAssemblerState* state_, TNode<String> p_string) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 228);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 231);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 229);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 236);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 232);
  ...
  if (block11.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/string.tq", 232});
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 233);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_1);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 226);
    ca_.Goto(&block17);
  }
...
TNode<String> Flatten_1(compiler::CodeAssemblerState* state_, TNode<ConsString> p_cons) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 241);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 242);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_1);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 240);
    ca_.Goto(&block4);
  }
...
void StaticAssertStringLengthFitsSmi_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 314);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 311);
    ca_.Goto(&block2);
  }
...
TNode<IntPtrT> AbstractStringIndexOf_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search, TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 331);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 328);
    ca_.Goto(&block2);
  }
...
TNode<IntPtrT> AbstractStringIndexOf_1(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search, TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 337);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 338);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 340);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 334);
    ca_.Goto(&block4);
  }
...
TNode<IntPtrT> AbstractStringIndexOf_2(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search, TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 346);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 343);
    ca_.Goto(&block2);
  }
...
TNode<IntPtrT> AbstractStringIndexOf_3(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search, TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 352);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 349);
    ca_.Goto(&block2);
  }
...
TNode<Smi> AbstractStringIndexOf_4(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TNode<String> p_searchString, TNode<Smi> p_fromIndex) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 376);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 382);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 383);
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 386);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 370);
...
TF_BUILTIN(StringIndexOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 392);
...
TNode<Int32T> LoadStringLength_0(compiler::CodeAssemblerState* state_, TNode<String> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 19);
...
TNode<Uint16T> Method_String_StringInstanceType_0(compiler::CodeAssemblerState* state_, TNode<String> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 12);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 11);
    tmp5 = (TNode<Uint16T>{tmp4});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 10);
    ca_.Goto(&block2);
  }
...
TNode<BoolT> Method_String_IsNotInternalized_0(compiler::CodeAssemblerState* state_, TNode<String> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 16);
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 15);
    ca_.Goto(&block2);
  }
...
TNode<String> LoadConsStringFirst_0(compiler::CodeAssemblerState* state_, TNode<ConsString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 50);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
...
TNode<String> LoadConsStringSecond_0(compiler::CodeAssemblerState* state_, TNode<ConsString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 51);
...
TNode<BoolT> Method_ConsString_IsFlat_0(compiler::CodeAssemblerState* state_, TNode<ConsString> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 43);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    ...
    tmp4 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp5 = CodeStubAssembler(state_).Word32Equal(TNode<Int32T>{tmp3}, TNode<Int32T>{tmp4});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 42);
    ca_.Goto(&block2);
  }
...
TNode<BoolT> Method_ConsString_IsOneByteRepresentation_0(compiler::CodeAssemblerState* state_, TNode<ConsString> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 47);
    tmp0 = Method_String_StringInstanceType_0(state_, TNode<String>{p_this});
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 46);
    ca_.Goto(&block2);
  }
...
TNode<ExternalPointerT> LoadExternalStringResource_0(compiler::CodeAssemblerState* state_, TNode<ExternalString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 57);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
...
TNode<ExternalPointerT> LoadExternalStringResourceData_0(compiler::CodeAssemblerState* state_, TNode<ExternalString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 59);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp1 = CodeStubAssembler(state_).LoadReference<ExternalPointerT>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }
...
TNode<RawPtrT> Method_ExternalOneByteString_GetChars_0(compiler::CodeAssemblerState* state_, TNode<ExternalOneByteString> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 79);
    tmp0 = Method_String_StringInstanceType_0(state_, TNode<String>{p_this});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 80);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 82);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_1);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 78);
    ca_.Goto(&block5);
  }
...
TNode<RawPtrT> Method_ExternalTwoByteString_GetChars_0(compiler::CodeAssemblerState* state_, TNode<ExternalTwoByteString> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 90);
    tmp0 = Method_String_StringInstanceType_0(state_, TNode<String>{p_this});
    tmp1 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 4, 1, uint16_t>>(ca_.UncheckedCast<Word32T>(tmp0)));
    ca_.Branch(tmp1, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 91);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 93);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_1);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 89);
    ca_.Goto(&block5);
  }
...
TorqueStructSlice_char16_ConstReference_char16_0 FieldSliceSeqTwoByteStringChars_0(compiler::CodeAssemblerState* state_, TNode<SeqTwoByteString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 114);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp1 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{p_o, tmp0});
    tmp2 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp1});
    tmp3 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xcull));
...
TNode<String> LoadSlicedStringParent_0(compiler::CodeAssemblerState* state_, TNode<SlicedString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 120);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp1 = CodeStubAssembler(state_).LoadReference<String>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }
...
TNode<Smi> LoadSlicedStringOffset_0(compiler::CodeAssemblerState* state_, TNode<SlicedString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 121);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
...
TNode<String> LoadThinStringActual_0(compiler::CodeAssemblerState* state_, TNode<ThinString> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 127);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp1 = CodeStubAssembler(state_).LoadReference<String>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }
...
TorqueStructSlice_char8_ConstReference_char8_0 Subslice_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_slice, TNode<IntPtrT> p_start, TNode<IntPtrT> p_length, compiler::CodeAssemblerLabel* label_OutOfBounds) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 14);
    ...
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 15);
...
TorqueStructSlice_char8_ConstReference_char8_0 NewOffHeapConstSlice_char8_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_startPointer, TNode<IntPtrT> p_length) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 190);
    tmp0 = kZeroBitPattern_0(state_);
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 191);
    ...
    ca_.SetSourcePosition("../../../src/builtins/torque-internal.tq", 189);
...
TNode<SeqOneByteString> AllocateNonEmptySeqOneByteString_UninitializedIterator_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content) {
  ...
  if (block2.is_used()) {
    ...
    InitializeFieldsFromIterator_char8_UninitializedIterator_0(state_, TorqueStructSlice_char8_MutableReference_char8_0{TNode<Object>{tmp14}, TNode<IntPtrT>{tmp18}, TNode<IntPtrT>{tmp8}, TorqueStructUnsafe_0{}}, TorqueStructUninitializedIterator_0{});
...
TNode<SeqTwoByteString> AllocateNonEmptySeqTwoByteString_UninitializedIterator_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 147);
    tmp0 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/string.tq", 147});
      CodeStubAssembler(state_).FailAssert("Torque assert 'length > 0 && length <= kStringMaxLength' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 149);
    tmp5 = kStringMap_0(state_);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 150);
    tmp6 = kNameEmptyHashField_0(state_);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 151);
    tmp7 = CodeStubAssembler(state_).Signed(TNode<Uint32T>{p_length});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 114);
    tmp8 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp7});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 148);
    tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp10 = AddIndexedFieldSizeToObjectSize_0(state_, TNode<IntPtrT>{tmp9}, TNode<IntPtrT>{tmp8}, kUInt16Size);
    tmp11 = AlignTagged_0(state_, TNode<IntPtrT>{tmp10});
    tmp12 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    tmp13 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    tmp14 = AllocateFromNew_0(state_, TNode<IntPtrT>{tmp11}, TNode<Map>{tmp5}, TNode<BoolT>{tmp12}, TNode<BoolT>{tmp13});
    ...
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp14, tmp17}, tmp7);
    tmp18 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    InitializeFieldsFromIterator_char16_UninitializedIterator_0(state_, TorqueStructSlice_char16_MutableReference_char16_0{TNode<Object>{tmp14}, TNode<IntPtrT>{tmp18}, TNode<IntPtrT>{tmp8}, TorqueStructUnsafe_0{}}, TorqueStructUninitializedIterator_0{});
    tmp19 = TORQUE_CAST(TNode<HeapObject>{tmp14});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 160);
    ca_.Goto(&block7);
  }
...
TNode<String> AllocateSeqOneByteString_UninitializedIterator_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 165);
    tmp0 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    ca_.SetSourcePosition("../../../src/objects/string.tq", 166);
...
TNode<SeqTwoByteString> UnsafeCast_SeqTwoByteString_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 214);
    ca_.Goto(&block4);
  }
...
TNode<Smi> TwoStringsToSlices_Smi_AbstractStringIndexOfFunctor_0(compiler::CodeAssemblerState* state_, TNode<String> p_s1, TNode<String> p_s2, TorqueStructAbstractStringIndexOfFunctor_0 p_f) {
  ...
  if (block56.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 296);
  ...
  if (block54.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 298);
  ...
  if (block107.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 304);
  ...
  if (block105.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 306);
...
TNode<Smi> Call_char8_char8_1(compiler::CodeAssemblerState* state_, TorqueStructAbstractStringIndexOfFunctor_0 p_self, TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/objects/string.tq", 367);
    tmp4 = Convert_intptr_Smi_0(state_, TNode<Smi>{p_self.fromIndex});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 364);
...
TNode<SeqTwoByteString> AllocateNonEmptySeqTwoByteString_SliceIterator_char16_ConstReference_char16_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructSliceIterator_char16_ConstReference_char16_0 p_content) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp14, tmp17}, tmp7);
    tmp18 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    InitializeFieldsFromIterator_char16_SliceIterator_char16_ConstReference_char16_0(state_, TorqueStructSlice_char16_MutableReference_char16_0{TNode<Object>{tmp14}, TNode<IntPtrT>{tmp18}, TNode<IntPtrT>{tmp8}, TorqueStructUnsafe_0{}}, TorqueStructSliceIterator_char16_ConstReference_char16_0{TNode<Object>{p_content.object}, TNode<IntPtrT>{p_content.start}, TNode<IntPtrT>{p_content.end}, TorqueStructUnsafe_0{}});
    tmp19 = TORQUE_CAST(TNode<HeapObject>{tmp14});
    ca_.SetSourcePosition("../../../src/objects/string.tq", 172);
    ca_.Goto(&block7);
  }
...
void InitializeFieldsFromIterator_char8_TwoByteToOneByteIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_MutableReference_char8_0 p_target, TorqueStructTwoByteToOneByteIterator_0 p_originIterator) {
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/wasm.tq", 837);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../../src/builtins/wasm.tq", 838);
    ...
    ca_.SetSourcePosition("../../../src/builtins/wasm.tq", 840);
    ...
    ca_.SetSourcePosition("../../../src/builtins/wasm.tq", 841);
