...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x0a1c5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0a1ed): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x0a215): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0a23d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0a265): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0a28d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x0a2b5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0a2dd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0a305): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0a32d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0a355): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0a37d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0a3a5): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0a3cd): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x0a3f5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0a41d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0a445): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0a46d): "PromiseThenFinallySharedFun",
  ("old_space", 0x0a495): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0a4bd): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0a4e5): "ProxyRevokeSharedFun",
  ("old_space", 0x0a50d): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x0a535): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0a55d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
